...
public class FindFriendGroupListAdapter extends RecyclerView.Adapter<FindFriendGroupListAdapter.VH> {
    ...
    @NonNull
    @Override
    public FindFriendGroupListAdapter.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LinearLayout.inflate(viewGroup.getContext(), R.layout.find_friend_groups_adapter, null);
        return new VH(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FindFriendGroupListAdapter.VH vh, final int i) {
