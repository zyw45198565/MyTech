    ...
    protected void initView() {
        ...
        checkGroupSmart.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                findUserJoinedGroupPresenter.reqeust(userId, sessionId);
            }
        });
        ...
        findFriendGroupListAdapter.setOnItemClickListener(new FindFriendGroupListAdapter.ClickListener() {
            ...
            public void click(int id) {
                transferFriendGroupPresenter.reqeust(userId,sessionId,id,friendId);
            }
        });
    }
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (TextUtils.isEmpty(input)) {
                                    ...
                                    addFriendGroupPresenter.reqeust(userId,sessionId,input);
                                }
                            }
                        })
